...
class SceneGraphGeneration:
    ...
    """
    def __init__(self, cfg, arguments, local_rank, distributed, split):
        """
...
def build_model(cfg, arguments, local_rank, distributed, split):
    return SceneGraphGeneration(cfg, arguments, local_rank, distributed, split)
