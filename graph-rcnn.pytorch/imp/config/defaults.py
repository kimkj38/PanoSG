...
_C.MODEL.WEIGHT_SGG = "/root/PanoSG/graph-rcnn.pytorch.checkpoints/checkpoint_final.pth"    # weight loading path for scene graph generator pre-trained model
